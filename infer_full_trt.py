...
from pipeline_stable_diffusion_xl_instantid_full_trt import StableDiffusionXLInstantIDPipeline, draw_kps
...
def parseArgs():
    ...
    parser.add_argument('--onnx-dir', default='./Tensorrt_Build/onnx_xl_test_full', help="Directory for SDXL ONNX models")
    parser.add_argument('--engine-dir', default='./Tensorrt_Build/engine_xl_test_full', help="Directory for SDXL TensorRT engines")
    ...
    parser.add_argument('--stages', nargs='+', type=str, default=['unet','clip', 'clip2','multicontrolnet'], help=" Model inference use Tensorrt, if not use torch!")
...
if __name__ == "__main__":
    ...
    pose_image = resize_img(pose_image, size=(args.width, args.height))
