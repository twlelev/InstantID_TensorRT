...
from pipeline_stable_diffusion_xl_instantid_trt import StableDiffusionXLInstantIDPipeline, draw_kps
...
def parseArgs():
    ...
    parser.add_argument('--onnx-dir', default='./Tensorrt_Build/onnx_infer_test', help="Directory for SDXL ONNX models")
...
if __name__ == "__main__":
    ...
    image.save('results/result_infer_trt.jpg')
    pipe.teardown()